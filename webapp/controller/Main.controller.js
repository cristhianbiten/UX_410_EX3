sap.ui.define(
  ...
  function (
    ...
    return Controller.extend("student28.sap.training.diagram.controller.Main", {
      onInit: function () {
      ...
      onChange: function (oEvent) {
        this.sCurrentSelectedDimension = oEvent
      ...
      _createTable: function () {
        ...
        oTable.addColumn(
          new Column({
            header: new Label({ text: "Region", textAlign: "Right" }),
          })
        );
        oTable.addColumn(
          new Column({
            header: new Label({ text: "Sub Region", textAlign: "Left" }),
          })
        );
        oTable.addColumn(
          new Column({ header: new Label({ text: "Product name" }) })
        );
        oTable.addColumn(
          new Column({ header: new Label({ text: "Sales Amount" }) })
        );
      ...
      _createSelector: function () {
        ...
        var oItemProduct = new Item({ key: "0", text: "{i18n>perProduct}" });
        var oItemRegion = new Item({ key: "1", text: "{i18n>perRegion}" });
        var oItemProductRegion = new Item({ key: "2", text: "{i18n>perProdReg}" });
