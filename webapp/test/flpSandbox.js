		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Diagrams",
									"targetURL": "#student28saptrainingdiagram-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student28saptrainingdiagram-display": {
								"semanticObject": "student28saptrainingdiagram",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student28.sap.training.diagram",
									"url": sap.ui.require.toUrl("student28/sap/training/diagram")
								}
							}
						}
					}
